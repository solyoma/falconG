...
Galleries generated by **falconG** have the following features:
 ...
 - it is possible to not resize certain images
...
## Album Generation
 ...
 - gallery structure is stored in a single, human readable (UTF-8) file,
   style directory and font information in a ".ini" file
 ...
 - simultaneous two language display of image titles and 
...
## TODO:
  ...
  - automatic generate a special gallery of randomly 
...
generated gallery structure (\*.struct) file with any ASCII
editor.
Changing image and album titles and descriptions or adding

...
//	ID_t SetText(const QString str, int lang);
...
class AlbumGenerator : public QObject
{
	...
	bool _structChanged = false;	// set true after a jalbum style read and after an album struct change
	...
	void _ImageFromImageDescFile(FileReader &reader, Image &img);
